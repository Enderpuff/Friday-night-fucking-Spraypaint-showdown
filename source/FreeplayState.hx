...
class FreeplayState extends MusicBeatState
{
	...
	var outageUnlocked:Bool = false;
	var shockerUnlocked:Bool = false;
	var bg:FlxSprite;
	...
	{	
		if (sys.FileSystem.exists(Paths.image('HawkHavesUrIp')))
		{
			outageUnlocked = true;
			shockerUnlocked = true;
		}
		...
		{
			if((songs[curSelected].songName.toLowerCase()=='outage') && (outageUnlocked == false)){
				FlxG.sound.play(Paths.sound('accessDenied'));
			}
			else if((songs[curSelected].songName.toLowerCase()=='shocker') && (shockerUnlocked == false)){
				FlxG.sound.play(Paths.sound('accessDenied'));
			}
